        ...
        <div className="about-me__wrapper">
          <div className="about-me__content">
            ...
            <p className="about-me__text">
              Я родилась и живу в Казани, заканчиваю КНИТУ-КАИ на специальность
              "Техник по информационным системам". У меня есть кот Барсик. Я
              люблю слушать музыку, а ещё увлекаюсь играми. Недавно начала
              кодить. После прохождения курса по веб-разработке, начала
